...
mod nanosecond_precision_tests {
    ...
    fn test_nanosecond_precision_not_lost() {
        ...
        let original_dt = Utc.with_ymd_and_hms(2025, 1, 7, 12, 34, 56)
            .unwrap()
        ...
        let reconstructed_dt = Utc.timestamp_opt(ticker_data.timestamp_secs as i64, ticker_data.timestamp_nanos)
            .single()
            .unwrap();
