...
build_wasm() {
    ...
    cd crates/wasm-bridge && wasm-pack build --target web --out-dir ../../web/pkg --dev && cd ../..
...
if command -v inotifywait &> /dev/null; then
    ...
    while inotifywait -r -e modify,create,delete crates/wasm-bridge/src/ crates/*/src/ crates/wasm-bridge/Cargo.toml crates/*/Cargo.toml 2>/dev/null; do
